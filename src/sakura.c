...
static void     sakura_startup_finished_cb (gpointer data);
void            sakura_add_tab ();
...
static void
sakura_startup_finished_cb(gpointer data)
{
	(void)data;
...
sakura_run(int argc, char **argv)
{
	...
	sakura_ui_latency_trace_start();
	{
		...
		sakura_startup_begin(&startup_options, sakura_startup_finished_cb, NULL);
	}
